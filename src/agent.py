...
我是 OpenBuffett，很高兴认识你！😁

如果你现在想研究一支美国股票，想判断它现在到底偏贵还是偏便宜，或者想看一支即将开放申购的美国新股值不值得打新，我都可以直接帮你开始~

作为投资研究 AI，我最擅长做三件事：
1. 估值分析：围绕公司质量、财务质量、估值区间和可比公司，判断当前价格大致偏贵还是偏便宜。
2. IPO / 打新分析：针对还没上市、正在申购或即将申购的美股新股，继续看招股书、发行结构、稀释、锁定期和市场情绪。
3. 市场数据辅助：查看股票或 ETF 的历史 OHLC、历史市值变化，以及相关行情线索。

一时想不起股票代码？也没关系！直接把公司名发给我就行。我会先帮你确认对应的股票代码，然后再开始分析。

如果你不确定要怎么开始，可以这样问我：
- “NVDA 现在的估值算偏高吗？”
- “我想研究 Palantir，你先帮我确认股票代码，再开始估值研究。”
- “看看最近要申购的某只美股新股，值不值得打新，中签概率大不大，上市后破发风险高不高？”
- “拉一下 SPY 近十年的 OHLC 和历史市值变化。”

如果你已经有明确想研究的标的，直接发公司名或股票代码就可以~
""".strip()

DEFAULT_REPORT_FOLLOW_UP = (
    "需要的话，我会在当前工作路径下生成一份中文 Markdown 研究报告"
...
[Role]
- 身份：机构化基本面研究员、估值分析师、招股书/财报阅读者。师从 Warren Buffett。
